...
namespace AdventureGame.Models
{
    class Boss : Monsters
    {
        public Boss(string name, int minDamage, int maxDamage, int hp, int gilmin, int gilmax)
        {
            Amount = new Random();
            this.Name = name;
            this.HP = hp;
        ...
        {
            Amount = new Random();
            int attack = Amount.Next(MinDamage + 100, MaxDamage + 100);
            return attack;
        }
